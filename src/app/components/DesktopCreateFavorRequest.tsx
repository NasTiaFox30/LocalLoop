...
export default function DesktopCreateFavorRequest({}: DesktopCreateFavorRequestProps) {
  ...
  const aiDescription = "Cześć! To moja wiertarka udarowa Bosch Professional, gotowa na Twoje projekty domowe. Jest w świetnym stanie, z baterią i ładowarką. Idealnie sprawdzi się do montażu mebli czy drobnych napraw. Chętnie podzielę się nią z sąsiadami! 🌱";
  ...
  return (
    <div className="hidden lg:block min-h-screen bg-[#2a2d35] text-[#f5f3ed]">
      <div className="max-w-[800px] mx-auto p-8 min-h-screen flex flex-col justify-center">
        <div className="mb-8">
          <h1 className="text-2xl font-medium text-[#f5f3ed] mb-2">Portal Tworzenia</h1>
          <p className="text-sm text-[#b8b5ad]">Stwórz nowe ogłoszenie z AI</p>
        </div>
          ...
          >
            {!imageUploaded ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <p className="text-sm text-[#b8b5ad] mt-2">AI przeanalizuje je automatycznie</p>
              </div>
            ) : (
              <ImageWithFallback
            ...
            <>
              <div className="backdrop-blur-md bg-gradient-to-br from-[rgba(60,65,75,0.5)] to-[rgba(50,55,65,0.3)] border border-[#7dd3c0]/15 rounded-[1.5rem] p-5 shadow-xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <label className="text-sm text-[#f5f3ed] font-medium">Opis Wygenerowany przez AI</label>
                </div>
                <div className="backdrop-blur-sm bg-[rgba(40,43,50,0.4)] border border-[#7dd3c0]/10 rounded-2xl p-4">
                  <p className="text-sm text-[#f5f3ed] leading-relaxed">{aiDescription}</p>
                </div>
              </div>
              ...
              <div className="backdrop-blur-md bg-gradient-to-br from-[rgba(60,65,75,0.5)] to-[rgba(50,55,65,0.3)] border border-[#89cff0]/15 rounded-[1.5rem] p-5 shadow-xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <label className="text-sm text-[#f5f3ed] font-medium">Sugerowana Wartość</label>
                </div>

                <div className="grid grid-cols-2 gap-3">
                  <button className="backdrop-blur-sm bg-gradient-to-r from-[#7dd3c0]/15 to-[#a8d5ba]/10 border border-[#7dd3c0]/25 rounded-2xl p-4 flex items-center gap-3 hover:scale-105 transition-all duration-300">
                  ...
                  <button className="backdrop-blur-sm bg-gradient-to-r from-[#89cff0]/15 to-[#b8d8e8]/10 border border-[#89cff0]/25 rounded-2xl p-4 flex items-center gap-3 hover:scale-105 transition-all duration-300">
                ...
                <p className="text-xs text-[#b8b5ad] mt-3 text-center">AI sugeruje na podstawie podobnych przedmiotów</p>
              </div>
